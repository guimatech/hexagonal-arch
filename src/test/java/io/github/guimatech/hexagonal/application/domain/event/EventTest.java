...
import io.github.guimatech.hexagonal.application.domain.event.ticket.TicketStatus;
...
class EventTest {
    ...
    void testCreateEventWithInvalidName() throws Exception {
        // given
        final var aPartner =
                Partner.newPartner("John Doe", "41.536.538/0001-00", "john.doe@gmail.com");
    ...
    void testCreateEventWithInvalidDate() throws Exception {
        // given
        final var aPartner =
                Partner.newPartner("John Doe", "41.536.538/0001-00", "john.doe@gmail.com");
    ...
    void testReserveTicketWhenEventIsSoldOut() throws Exception {
        // given
        final var aPartner =
                Partner.newPartner("John Doe", "41.536.538/0001-00", "john.doe@gmail.com");
    ...
    void testReserveTwoTicketsForTheSameClient() throws Exception {
        // given
        final var aPartner =
                Partner.newPartner("John Doe", "41.536.538/0001-00", "john.doe@gmail.com");
